# /opt/balthub/apps/core/admin.py
...
class ParserAdmin(admin.ModelAdmin):
    ...
    def run_now_button(self, obj):
        ...
        url = reverse("admin:core_parser_run", args=[obj.pk])
    ...
    def run_parser_view(self, request, parser_id):
        ...
        if parser is None:
            ...
            return redirect("admin:core_parser_changelist")
        ...
        return redirect(
            reverse("admin:core_parser_change", args=[parser.id])
        )
